load_packages <- function(packages){
    ...
    paquetes_instalados <- packages %in% rownames(installed.packages())

    if (any(paquetes_instalados == FALSE)) {
    install.packages(packages[!paquetes_instalados], 
...
crear_carpetas_de_experimento <- function(carpetas){
    for (carpeta in carpetas) {
        dir.create(here(carpeta))
    }
}
